...
- Configure controller type and motor IDs in Elastic Dashboard "Motor Test" tab.
...
- **Always hold A button** (or enable toggle on Elastic Dashboard) to allow motor output.
