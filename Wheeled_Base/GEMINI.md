# Wheeled_Base - Gemini Configuration

This is a project-level redirect file.

## Configuration Hierarchy

When working in the Wheeled_Base project, Gemini should read configurations in this order:
...
3. **This project:**
   - Wheeled_Base is a base wheeled/tank drive test project
...
## Wheeled_Base Project Details

**Purpose:** Base wheeled/tank project for hardware validation and calibration.
