...
public final class Constants {
  ...
  public static final class DriveConstants {
    ...
    public static final DriveMode DRIVE_MODE = DriveMode.ARCADE;
    ...
    public static final MotorConfig[] LEFT_MOTORS = new MotorConfig[] {
        new MotorConfig(MotorControllerType.SPARK_MAX, MotorKind.BRUSHLESS, 1, true, DRIVE_GEAR_RATIO, true)
        // Add followers here if needed.
    };

    public static final MotorConfig[] RIGHT_MOTORS = new MotorConfig[] {
        new MotorConfig(MotorControllerType.SPARK_MAX, MotorKind.BRUSHLESS, 2, false, DRIVE_GEAR_RATIO, true)
        // Add followers here if needed.
    };
  }
