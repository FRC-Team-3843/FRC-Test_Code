...
public class Vision {
  ...
  public Vision(double maxLatencySeconds) {
  ...
  public void addVisionMeasurements(DifferentialDrivePoseEstimator estimator) {
    if (fieldLayout == null) {
      return;
    }
    ...
    for (Cameras camera : Cameras.values()) {
      ...
      estimator.addVisionMeasurement(pose.estimatedPose.toPose2d(), pose.timestampSeconds, camera.curStdDevs);
    }
  }
