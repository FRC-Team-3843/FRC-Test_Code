...
- [registry] Feature enable-flags in `Constants` gate all features. `LoggingConstants` example: `ENABLE_LOGGING`, `ENABLE_MOTOR_LOGGING` (Motor_Test), `ENABLE_DRIVE_TELEMETRY` (drive bases). #telemetry
