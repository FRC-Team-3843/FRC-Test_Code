# FRC-Test_Code Repository - Gemini Configuration

## How to Use This Configuration

This file is for Gemini-specific behavior when working in the FRC-Test_Code repository.
...
- **Code Generation:** Keep test code minimal and focused on hardware validation.
...
**After work:** Log all test results and findings with `[GEMINI]` tag.
