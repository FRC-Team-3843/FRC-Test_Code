...
public final class MotorConfiguration {
  ...
  private static ControllerType deriveControllerType(
    ...
    if (!controllerFamily.supportsTransport(transport)
        || !controllerFamily.hasRuntimeSupport(transport)) {
      return ControllerType.UNSUPPORTED;
    }
    ...
    switch (controllerFamily) {
      ...
      case VICTOR_SPX:
        return ControllerType.VICTOR_SPX;
      case TALON_FX:
