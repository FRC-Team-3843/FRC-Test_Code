...
public final class ChoreoAutos {
  ...
  public static Command buildAuto(String name, SwerveSubsystem swerve) {
    try {
      ...
      Command command = tryBuildCommand(choreoClass, trajectory, swerve);
  ...
  private static Command tryBuildCommand(Class<?> choreoClass, Object trajectory, SwerveSubsystem swerve)
      throws Exception {
    ...
    Supplier<?> poseSupplier = swerve::getPose;
    Object kinematics = swerve.getKinematics();
    Consumer<ChassisSpeeds> speedsConsumer = swerve::driveRobotRelative;
