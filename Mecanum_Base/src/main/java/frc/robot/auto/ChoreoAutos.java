...
public final class ChoreoAutos {
  ...
  public static Command buildAuto(String name, MecanumDriveSubsystem drive) {
    try {
  ...
  private static Command tryBuildCommand(Class<?> choreoClass, Object trajectory, MecanumDriveSubsystem drive)
      throws Exception {
